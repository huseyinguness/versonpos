...
<title>Verson RestorantPos Fiş Yazdır</title>
</head>
...
$dizi["ad"];
					...
					<tr>
						...
						<strong>MASA :</strong> '.$dizi["ad"].'</td>
						</tr>
						<tr>
						<td colspan="3" class="border-top-0 text-left">
						<strong>Tarih :</strong> '.date("d.m.Y").'</td>
						</tr>
						<tr>
						<td colspan="3" class="border-top-0 text-left">
						<strong>Saat :</strong> '.date("h:i:s").'</td>
						</tr>';
		...
		<td colspan="2" class="border-top-0 text-center">'.number_format($sontutar,2,'.',',').' ₺ </td>
		</tr>											
						</tbody></table>
						 <form id="hesapform"> 	
