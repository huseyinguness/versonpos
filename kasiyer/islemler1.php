...
function formgetir($masaid,$db,$baslik,$durum,$btnvalue,$btnid,$formvalue,$BolumTercih) {
	...
	$masadeg=benimsorum2($db,"select * from masalar where durum=$durum and rezervedurum=0 and kategori=$BolumTercih",1); 
							...
							if ($masaid!=$son["id"]) :
							echo '<option value="'.$son["id"].'" class="form-control">'.$son["ad"].'</option>';
							endif;
...
function iskontogetir($masaid) {
	...
	echo '<div class="card border-secondary m-3 mx-auto" style="max-width:18rem;">
	<div class="card-header"><b class="text-secondary">İSKONTO UYGULA </b><span id="kapatma">
	<a class="text-danger float-right"  sectionId="iskonto"><b><i class="fas fa-sign-out-alt"></i></b></a></span></div>
...
function parcagetir($masaid) {
	...
	echo '<div class="card border-secondary m-3  mx-auto" style="max-width:18rem;">
	<div class="card-header"><b class="text-secondary">PARÇA HESAP AL </b><span id="kapatma">
	<a class="text-danger float-right"  sectionId="parca"><b><i class="fas fa-sign-out-alt"></i></b></a></span></div>
...
case "butonlar":
	...
	echo '<div class="row">
				...
				<div class="col-lg-12 mt-2 table-info text-center pt-2 mb-2"><h4>MASA İŞLEM MENÜSÜ</h4>	</div>
						...
						<input type="button" id="btnn" value="HESAP AL" style="font-weight:bold; height:40px;" class="btn btn-dark col-lg-12  mt-1"   />						
							  <div class="row text-center mt-1" id="odemeSecenek">

						 <div class="col-md-3  border border-secondary  m-1 mx-auto p-3 rounded" id="nakit">Nakit</div>
								   <div class="col-md-3 t border border-secondary m-1 mx-auto p-3 rounded" id="kredi">K.Kartı</div>
								   <div class="col-md-3  border border-secondary m-1 mx-auto p-3 rounded" id="ykarti">Y.Kartı </div>								   
						</div>	
		...
		<div class="col-md-5 mt-1 mb-1 font-weight-bold rounded text-danger border border-danger  mx-auto p-2" id="ParaUstuSonuc"> Para üstü hesapla								  
						...
						echo'<p><a href="fisbastir.php?masaid='.$masaid.'" onclick="ortasayfa(this.href,\'mywindow\',\'350\',\'400\',\'yes\');return false" class="btn btn-dark btn-block mt-1" style="height:40px;" ><i class="fas fa-print mt-1"> FİŞ BASTIR</i></a></p> 
						 	 ...
						 	 <div class="col-md-4">
										 <div class="row">
	<div class="col-md-12" id="islemlinkleri"><a  class="btn btn-dark btn-block mt-1 text-white" style="height:40px;" sectionId="degistir">
	<i class="fas fa-exchange-alt mt-1 float-left"> MASA DEĞİŞTİR</i></a> </div>
	 <div class="col-md-12" id="degistirform">'; formgetir($masaid,$db,"<b class='text-secondary'>MASA DEĞİŞTİR</b><span id='kapatma'>
	 	<a class='text-danger float-right'  sectionId='degistir'><b><i class='fas fa-sign-out-alt'></i></b></a></span>",0,"DEĞİŞTİR","degistirbtn","degistirformveri",$sistem->BolumTercihGetir($db)); echo'</div>

	<div class="col-md-12" id="islemlinkleri"><a  class="btn btn-dark text-white btn-block mt-1" style="height:40px;" sectionId="birlestir"><i class="fas fa-stream mt-1 float-left"> MASA BİRLEŞTİR</i></a>  </div>		 <div class="col-md-12" id="birlestirform">'; formgetir($masaid,$db,"<b class='text-secondary'>MASA BİRLEŞTİR</b><span id='kapatma'>
		<a class='text-danger float-right' sectionId='birlestir'><b><i class='fas fa-sign-out-alt'></i></b></a></span>",1,"BİRLEŞTİR","birlestirbtn","birlestirformveri",$sistem->BolumTercihGetir($db)); echo'</div>													 
										 </div>
								 	 ...
								 	 <div class="col-md-4">
										 ...
										 <div class="row">
										 		<div class="col-md-12" id="islemlinkleri"><a  class="btn btn-dark text-white btn-block mt-1" style="height:40px;" sectionId="iskonto">
	...
	<div class="col-md-12" id="parcaform">'; parcagetir($masaid); echo'</div>	
				...
				<div class="col-lg-12 mt-2 table-success text-center pt-2 mb-2"><h4>GENEL İŞLEM MENÜSÜ</h4>	</div>
				<div class="col-md-4">	
						<div class="row">
							<div class="col-md-12" id="islemlinkleri">
							<a  class="btn btn-dark text-white btn-block mt-1" style="height:40px;" sectionId="rezerveyap">
							<i class="fas fa-address-book  mt-1 float-left"> REZEVASYON  YAP</i></a> </div>
												
	<div class="col-md-12" id="rezerveyapform">'; rezerveFonk($masaid,$db,"<b class='text-secondary'>REZEVASYON YAP</b><span id='kapatma'>
		<a class='text-danger float-right' sectionId='rezerveyap'><b><i class='fas fa-sign-out-alt'></i></b></a></span>",0,"REZERVE ET","rezerveetbtn","rezerveyapFormu"); echo'</div>
										...
										<div class="col-md-4">
												 <div class="row">											
												 <div class="col-md-12" id="islemlinkleri">
												 <a  class="btn btn-dark text-white btn-block mt-1" style="height:40px;" sectionId="rezervekaldir">
												 <i class="fas fa-angle-up mt-1 float-left"> REZEVASYON KALDIR</i></a>  </div>
												 
	<div class="col-md-12" id="rezervekaldirform">'; rezerveFonk($masaid,$db,"<b class='text-secondary'>REZEVASYON KALDIR</b><span id='kapatma'>
		<a class='text-danger float-right' sectionId='rezervekaldir'><b><i class='fas fa-sign-out-alt'></i></b></a></span>",1,"REZERVE KALDIR","rezervekaldirbtn","rezervekaldirFormu"); echo'</div>												 
										 </div>
								</div> </div>
