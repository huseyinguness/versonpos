...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	<link rel="stylesheet" href="dosya/sistem.css" >
				 ...
				 benimsorum2($db,"delete from masabakiye where masaid=$id",1);		 
				  /* MASANIN LOG KAYDI*/											
					...
					<tbody>
						...
						<tr colspan="1" class="bg-light text-dark text-center">
						...
						<td colspan="1" class="font-weight-bold text-danger ">';
							...
							<font class='text-dark'><br>". number_format($kalanTutar,2,'.',',')." ₺</font></p>" ;	
							else:							
							echo '<p class="text-danger m-0 p-0">
...
case "butonlar":
	...
	echo '<div class="row">
				...
				<div class="col-lg-12 mt-2 table-danger pt-2 mb-2"><h4>Masa İşlem Menüsü</h4></div>
